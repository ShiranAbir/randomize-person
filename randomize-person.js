...
function getRandomPerson() {
    ...
    const person = {
        personalDetails:getPersonalDetails(gender),
        contactDetails:{},
        ...
        id:getRandomId(),
        preferredHexColor:getRandomHexColor(),
        lastSeen:getRandomLastSeen(),
        passportNum:getRandomPassportNumber(),
        jobTitle:getRandomJobTitle(),
        postalCode:getRandomPostalCode(),
        birthDay:getRandomBirthDay(),
        maritalStatus:getRandomMaritalStatus(),
        childrenAmount:getRandomChildrenAmount(),
        education:getRandomEducation(),
        password:getRandomPassword(),
        driversLicenseType:getRandomDriversLicenseType(),
        currentAccount:getRandomCurrentAccount(),
        vehicleNumberPlate:getRandomVehicleNumberPlate()
    }
...
function getRandomBirthDay() {
    ...
    const age = new Date().getFullYear() - parseInt(date.split(' ')[3])
    return {date,age}
}
...
function getRandomFinance(){
    return {currentAccount:getRandomCurrentAccount(),salary:getRandomSalary()}
}
...
function getRandomYearsOfExperience(){

}

function getPersonalDetails(gender){
    ...
    return [{firstName,lastName,id:getRandomId(),passportNum:getRandomPassportNumber(),birthDay:getRandomBirthDay()},{email,mobie:getRandomMobile(),phone:getRandomPhone()}]
}